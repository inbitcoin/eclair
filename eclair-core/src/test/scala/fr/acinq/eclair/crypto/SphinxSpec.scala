...
object SphinxSpec {
  val privKeys = Seq(
    PrivateKey(hex"4141414141414141414141414141414141414141414141414141414141414141", compressed = true),
    PrivateKey(hex"4242424242424242424242424242424242424242424242424242424242424242", compressed = true),
    PrivateKey(hex"4343434343434343434343434343434343434343434343434343434343434343", compressed = true),
    PrivateKey(hex"4444444444444444444444444444444444444444444444444444444444444444", compressed = true),
    PrivateKey(hex"4545454545454545454545454545454545454545454545454545454545454545", compressed = true)
  )
  ...
  val sessionKey: PrivateKey = PrivateKey(hex"4141414141414141414141414141414141414141414141414141414141414141", compressed = true)
  val payloads = Seq(
